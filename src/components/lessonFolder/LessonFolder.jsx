...
const LessonFolder = ({ lessonFolder }) => {
  ...
  return (
    <div style={{ cursor: "pointer" }} onClick={onClickOnFolder}>
      <div
        className={`lesson-folder 
          ...
          {warning && (
            <h3
              className={`warning-text ${
                warning === true ? "animate-text-in" : ""
              }`}
            >
              Sorry, you have to finish previous folder first
            </h3>
          )}
          {!warning && (
        ...
        <Row align="middle">
          ...
          <Col span={10} className="folder-details">
            <p className="folder-title">
              {lessonFolder.folderDetails[0].folderTitle}
            </p>
